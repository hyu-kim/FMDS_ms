...
Current Address: \#\!a Global Manufacturing Sciences and Technology, Sanofi, Framingham, MA 01707, USA
...
Next, the representation points were iteratively adjusted so that the $p$-value calculated in 2D space \hl{matches} to the original PERMANOVA $p$-value.
...
Under this rule, the algorithm \hl{stopped} in fewer than 30 iterations when $\lambda\geq0.2$ (Fig \ref{fig:sim_iter}B). 
...
{\bf Stabiliity and trajectories of PERMANOVA $p$-values from $F$-MDS representations.}
