...
\paragraph*{S2 Fig.}
\label{fig:fmds_track_cont}
{\bf Changes in $p$-values for group difference in $F$-informed MDS representations without stopping rule.}
